...
userRoutes.post('/password/request-change', checkToken(ROLES.ADMIN, ROLES.CUSTOMER), userController.requestChangePassword)
userRoutes.post('/password/resend-change-otp', checkToken(ROLES.ADMIN, ROLES.CUSTOMER), userController.resendChangePasswordOTP)
userRoutes.delete('/password/cancel-change-request', checkToken(ROLES.ADMIN, ROLES.CUSTOMER), userController.cancelChangeRequest)
